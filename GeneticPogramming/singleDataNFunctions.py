...
def delay(this: GeneralData, aNum: int = 1) -> GeneralData:
    ...
    outputToReturn.generalData[-aNum:, :] = np.nan
    outputToReturn.generalData = np.roll(outputToReturn.generalData, aNum, axis = 0)
    # print(id(outputToReturn))
    # print(id(outputToReturn.generalData))
...
def delta(this: GeneralData, aNum: int = 1) -> GeneralData:
    ...
    # print(id(outputToReturn.generalData))
    outputToReturn.generalData[-aNum:, :] = np.nan
    outputToReturn.generalData = np.subtract(outputToReturn.generalData, np.roll(outputToReturn.generalData, aNum, axis = 0))
    # print(id(outputToReturn))
    # print(id(outputToReturn.generalData))
    return outputToReturn
...
def pct_change(this: GeneralData, aNum: int = 1) -> GeneralData:
    ...
    # print(id(outputToReturn.generalData))
    outputToReturn.generalData[-aNum:, :] = np.nan
    delay = np.roll(outputToReturn.generalData, aNum, axis = 0)
    delta = np.subtract(outputToReturn.generalData, delay)
